...
# dataset parameters (if not using run_exp file)
...
epochs = 100       # number of epochs used for training (cuts off early based on loss threshold + delta)
